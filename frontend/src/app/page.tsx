  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-black via-purple-900 to-indigo-900 px-4">
      ...
      <div className="relative backdrop-blur-3xl bg-white/5 border border-white/20 rounded-3xl p-12 max-w-md w-full text-center shadow-3xl transform transition-transform hover:scale-105 hover:rotate-1 hover:shadow-4xl animate-float-card">
        <h1 className="text-5xl sm:text-6xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-500 to-cyan-400 animate-glow-text mb-4 break-words max-w-full">
          IntelliGPA
        </h1>
        <p className="text-gray-300 text-lg mb-10 animate-fade-slide">
          Your AI-powered academic assistant. Track, plan, and excel effortlessly.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-slide delay-200">
          <Link
            href="/login"
            className="flex-1 rounded-xl bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 text-white font-bold px-6 py-3 shadow-xl hover:shadow-2xl hover:scale-105 hover:-translate-y-1 transition-all duration-300"
          >
            Login
          </Link>
          <Link
            href="/signup"
            className="flex-1 rounded-xl border border-blue-400 text-blue-400 hover:bg-gradient-to-r hover:from-blue-500 hover:via-indigo-500 hover:to-purple-500 hover:text-white font-bold px-6 py-3 shadow-xl hover:shadow-2xl hover:scale-105 hover:-translate-y-1 transition-all duration-300"
          >
            Sign Up
          </Link>
        </div>
