      ...
      <div className="relative backdrop-blur-3xl bg-white/5 border border-white/20 rounded-3xl p-12 max-w-md w-full text-center shadow-3xl transform transition-transform hover:scale-105 hover:rotate-1 hover:shadow-4xl animate-float-card">
        ...
        <form onSubmit={handleSignUp} className="space-y-4">
          <div>
            ...
            <input
              type="email"
              className="w-full rounded border p-2 bg-white/10 text-white placeholder-gray-300 border-white/30"
              value={email}
          ...
          <button
            type="submit"
            className="w-full rounded bg-gradient-to-r from-blue-500 via-indigo-500 to-purple-500 text-white p-2 font-semibold shadow-lg hover:shadow-2xl transition-all duration-300"
          >
            Sign Up
          </button>
        </form>
